...
export const selectClient = createAction('[Clients] Select Client', props<{ client: Client | null }>());
export const addOrUpdateClient = createAction('[Clients] Add or Update Client', props<{ client: Client }>());
export const deleteClient = createAction('[Clients] Delete Client', props<{ client: Client }>());
export const clientsError = createAction('[Clients] Clients Error', props<{ errorMessage: string }>());
